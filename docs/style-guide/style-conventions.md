...
- Don't use dashes (*em* or *en* dashes.)
    - Use parenthesis to clarify information.
...
- Observe this rule to place the admonition on your text:
    ...
    - For other content, type the admonition right after the content it's referring to.

## Iconography

The Status documentation uses the application icons to guide readers' actions on the app.

- A document with many icons is harder to follow and scan. Therefore, use icons selectively, only when it's unclear where to click or tap.
